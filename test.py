...
class CollocationTestCase(unittest.TestCase):
    ...
    def test_collocations(self):
        ...
        self.assertEqual(right_counter["dolor"], 0, "Should be 0")
        self.assertEqual(left_counter["dolor"], 1, "Should be 1")
    ...
    def test_start_collocation_analysis(self):
        ...
        self.assertEqual(left_counter["dolor"], 2, "Should be 2")
        self.assertEqual(right_counter["dolor"], 2, "Should be 1")
